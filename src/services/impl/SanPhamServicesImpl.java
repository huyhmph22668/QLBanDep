 ...
 * @author LE DUONG
 */
public class SanPhamServicesImpl implements ISanPhamServices {
    ...
    public List<SanPhamViewModel> getListSanPham() {
        try {
            ...
            Logger.getLogger(SanPhamServicesImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
        return getListSP;
    }

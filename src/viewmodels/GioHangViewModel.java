...
public class GioHangViewModel {
    ...
    public GioHangViewModel(String MaSP, String TenSP, String MauSac, String KichCo, int SoLuong, Double DonGia, Double ThanhTien, Double GiamGia, String HinhThucGiamGia) {
        this.MaSP = MaSP;
        this.TenSP = TenSP;
        this.MauSac = MauSac;
        this.KichCo = KichCo;
